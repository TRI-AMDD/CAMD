...
class StructureDomain(DomainBase):
    ...
    def hypo_structures(self):
        """
        Returns (dataframe): Hypothetical structures generated by protosearch, filtered by n_max_atoms
    ...
    def hypo_structures_dict(self):
        """
        Returns (dict): Hypothetical structures generated by protosearch, filtered by n_max_atoms
    ...
    def candidates(self, include_composition=True):
        """
        This is the recommended convenience method that returns a fully-featurized set of hypothetical structures.
        Args:
