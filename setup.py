...
setup(
    ...
    dependency_links=[
        ...
        "git+ssh://@github.awsinternal.tri.global/materials/bulk_enumerator#egg=bulk_enumerator",
        "git+ssh://@github.awsinternal.tri.global/materials/protosearch#egg=protosearch"
    ]
)
