...
def run_analysis_alm(exploration_space_df, record_list):
    ...
    allALM_val = almAnalyzer.gather_allALM(exploration_space_df, record_list, percentile=0.01)
...
if __name__ == "__main__":
    ...
    ax.fill_between(np.arange(len(deALM_ucb[0])), deALM_ucb.mean(axis=0)-deALM_ucb.std(axis=0), deALM_ucb.mean(axis=0)+deALM_ucb.std(axis=0), color = 'blue', alpha=0.5)
    ax.fill_between(np.arange(len(deALM_random[0])), deALM_random.mean(axis=0)-deALM_random.std(axis=0), deALM_random.mean(axis=0)+deALM_random.std(axis=0), color = 'red', alpha=0.5)

    plt.axis([-1, max_budget+1, -1.5, 1.5])
    plt.legend([random_dealm_plot[0], ucb_dealm_plot[0]], ['Random Agent', 'UCB Agent'], loc='upper right', frameon=False, fontsize=13)
    ...
    # plt.show()
    plt.savefig("%s/alm_metric_alm_numSeed_%s_maxBudget_%s.png" % (fig_path, str(num_seed), str(max_budget)), dpi=100,bbox_inches='tight')
    ...
    ax.fill_between(np.arange(len(anyALM_ucb[0])), anyALM_ucb.mean(axis=0)-anyALM_ucb.std(axis=0), anyALM_ucb.mean(axis=0)+anyALM_ucb.std(axis=0), color = 'blue', alpha=0.5)
    ax.fill_between(np.arange(len(anyALM_random[0])), anyALM_random.mean(axis=0)-anyALM_random.std(axis=0), anyALM_random.mean(axis=0)+anyALM_random.std(axis=0), color = 'red', alpha=0.5)
    ...
    # plt.show()
    plt.savefig("%s/any_metric_alm_numSeed_%s_maxBudget_%s.png" % (fig_path, str(num_seed), str(max_budget)), dpi=100,bbox_inches='tight')
    ...
    ax.fill_between(np.arange(len(allALM_ucb[0])), allALM_ucb.mean(axis=0)-allALM_ucb.std(axis=0), allALM_ucb.mean(axis=0)+allALM_ucb.std(axis=0), color = 'blue', alpha=0.5)
    ax.fill_between(np.arange(len(allALM_random[0])), allALM_random.mean(axis=0)-allALM_random.std(axis=0), allALM_random.mean(axis=0)+allALM_random.std(axis=0), color = 'red', alpha=0.5)
    ...
    # plt.show()
    plt.savefig("%s/all_metric_alm_numSeed_%s_maxBudget_%s.png" % (fig_path, str(num_seed), str(max_budget)), dpi=100,bbox_inches='tight')
    ...
    ax.fill_between(np.arange(len(simALM_ucb[0])), simALM_ucb.mean(axis=0)-simALM_ucb.std(axis=0), simALM_ucb.mean(axis=0)+simALM_ucb.std(axis=0), color = 'blue', alpha=0.5)
    ax.fill_between(np.arange(len(simALM_random[0])), simALM_random.mean(axis=0)-simALM_random.std(axis=0), simALM_random.mean(axis=0)+simALM_random.std(axis=0), color = 'red', alpha=0.5)
    ...
    plt.text(0, min(simALM_ucb.mean(axis=0).min(), simALM_random.mean(axis=0).min()), "Number of Seed: %s\n" % str(num_seed), dict(size=14))

    # plt.show()
    plt.savefig("%s/sim_metric_alm_numSeed_%s_maxBudget_%s.png" % (fig_path, str(num_seed), str(max_budget)), dpi=100,bbox_inches='tight')
