...
# This is the worst
docker run -it \
	-e TRI_PATH=/home/camd/matr.io -e CAMD_DFT_TESTS=True -e TRI_BUCKET=matr.io \
	...
	bash -c 'export PATH=$PATH:$TRI_PATH/bin; nosetests camd/experiment/tests/test_dft.py'
